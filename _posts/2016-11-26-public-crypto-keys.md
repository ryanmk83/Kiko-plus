...
[PGP ("Pretty Good Privacy")](https://en.wikipedia.org/wiki/Pretty_Good_Privacy) is a highly-secure encryption protocol that that can be used with email. For the casual user, PGP is complicated and difficult to use. If you aren't worried worried about surveillance by a nation-state, I recommend [Mailvelope](https://www.mailvelope.com) as a good first step. Mailvelope is an easy (read: dead simple) product to setup and use. It's not perfect, but it's an okay start. It's probably faster, easier, and more reliable/secure (read: better) to us a product like [ricochet.im](http://ricochet.im) or an XMPP service via [Tor Messenger](https://trac.torproject.org/projects/tor/wiki/doc/TorMessenger#Downloads) or on [Adium](https://www.adium.im) than it is to use PGP with email. Here's a good article on getting started with those services: [Micah Lee, Chatting in Secret While We’re All Being Watched, The Intercept (July 2015)](https://theintercept.com/2015/07/14/communicating-secret-watched/).  
